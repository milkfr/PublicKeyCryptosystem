...
public class MainActivity extends Activity implements
	...
	public void onSectionAttached(int number) {
		...
		case 1:
			break;
		case 2:
			Intent intentRSA = new Intent(this, RSAActivity.class);
			startActivity(intentRSA);
			break;
		case 3:
			Intent intentRabin = new Intent(this, RabinActivity.class);
			startActivity(intentRabin);
			break;
		case 4:
			Intent intentElGamal = new Intent(this, ElGamalActivity.class);
			startActivity(intentElGamal);
			break;
		case 5:
